...
public class ParallelTest {
    ...
    public void testParallel(){
        Results results = Runner.path("classpath:auth").outputCucumberJson(true).parallel(4);
    ...
    private static void generateReport(String karateOutputPath){
        ...
        Configuration config = new Configuration(new File("target"), "TybaAutomationChallengeBE");
